...
- WSR 배포/업데이트 자동화 개선
- Blender MCP Provider는 2026-09-07 실제 프로젝트 수요로 선행 구현
- Windows Computer Use Provider도 2026-09-07 시각 피드백/데스크톱 UI 조작 수요로 선행 구현
- 이후 추가 MCP Provider는 실제 프로젝트 수요가 생길 때 추가
...
**현재 상태: Core 1차 구현 완료. 최신 코드 활성화를 위한 WSR 재시작/도구 새로고침 후 실전 확인만 남음.**
